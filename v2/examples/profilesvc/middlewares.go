...
func (mw loggingMiddleware) PostProfile(ctx context.Context, p Profile) (err error) {
	defer func(begin time.Time) {
		mw.logger.Info("profile call", "method", "PostProfile", "id", p.ID, "duration", time.Since(begin), "err", err)
	}(time.Now())
...
func (mw loggingMiddleware) GetProfile(ctx context.Context, id string) (p Profile, err error) {
	defer func(begin time.Time) {
		mw.logger.Info("profile call", "method", "GetProfile", "id", id, "duration", time.Since(begin), "err", err)
	}(time.Now())
...
func (mw loggingMiddleware) PutProfile(ctx context.Context, id string, p Profile) (err error) {
	defer func(begin time.Time) {
		mw.logger.Info("profile call", "method", "PutProfile", "id", id, "duration", time.Since(begin), "err", err)
	}(time.Now())
