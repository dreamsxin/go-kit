...
v2.18.0 is the candidate being prepared from `main` for the module:
...
subdirectory, but consumers request normal module versions such as `v2.13.0`.
...
The v2.18.0 candidate satisfies these criteria:
