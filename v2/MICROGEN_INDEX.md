...
Purpose:
- Give maintainers and AI agents one short entry point for `microgen` design and compatibility docs.
...
Use this when deciding roadmap direction, ownership boundaries, milestone order, CLI surface direction, or release-level scope.
...
If a `microgen` change affects generated files, startup behavior, extend mode, or rerun expectations, treat it as a product change and read the design and compatibility docs before editing templates.
