...
func TestGenerateFull_GoMod_Created(t *testing.T) {
	...
	mustContain(t, goModPath, "github.com/dreamsxin/go-kit/v2 v2.4.3")
...
func TestGenerateFull_GoMod_WithGRPCRequiresGRPCIntegration(t *testing.T) {
	...
	mustContain(t, filepath.Join(outDir, "go.mod"), "github.com/dreamsxin/go-kit/v2/integrations/grpc v0.2.5")
}
