...
func TestGenerateFull_GoMod_Created(t *testing.T) {
	...
	mustContain(t, goModPath, "github.com/dreamsxin/go-kit/v2 v2.5.2")
...
func TestGenerateFull_GoMod_WithGRPCRequiresGRPCIntegration(t *testing.T) {
	...
	mustContain(t, filepath.Join(outDir, "go.mod"), "github.com/dreamsxin/go-kit/v2/integrations/grpc v0.2.9")
}
...
func TestGenerateFull_Readme_Contents(t *testing.T) {
	...
	mustContain(t, readmePath, "The same contract drives HTTP routes, gRPC/proto assets, generated clients, SDKs, OpenAPI and JSON Schema output, README endpoint listings, and optional MCP tools.")
