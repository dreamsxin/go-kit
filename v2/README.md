...
This directory is the independent Go major-version module
`github.com/dreamsxin/go-kit/v2`. Breaking API and generated-output changes are
allowed here until the v2 release contract is frozen. The repository root remains
the v1 stable module.
...
The copied release and stability documents describe the v1 baseline and will be
revised as the v2 contracts are finalized.
...
# After the v2.0.0 tag is published:
