...
| `-openapi` | Generate OpenAPI 3.1, JSON Schema 2020-12, and Swagger UI |
...
5 is an embedded viewer and does not require CDN access.
...
`docs/`; treat them as generator-owned. Generated JSON is UTF-8 without BOM.
