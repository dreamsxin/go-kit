...
import (
	...
	httptransportserver "github.com/dreamsxin/go-kit/transport/http/server"
)
...
func encodePostProfileRequest(ctx context.Context, req *http.Request, request interface{}) (*http.Request, error) {
	// r.Methods("POST").Path("/profiles/")
	req.URL.Path = "/profiles/"
	return encodeRequest(ctx, req, request)
}

func encodeGetProfileRequest(ctx context.Context, req *http.Request, request interface{}) (*http.Request, error) {
...
func encodePutProfileRequest(ctx context.Context, req *http.Request, request interface{}) (*http.Request, error) {
...
func encodeRequest(_ context.Context, req *http.Request, request interface{}) (*http.Request, error) {
